        ...
        try:
            ...
            for match in filter_matches:
                ...
                if field:
                    # מיפוי אופרטור
                    operator_map = {
                        'גדול מ': '>', 'greater than': '>', 'above': '>', '>': '>',
                        'קטן מ': '<', 'less than': '<', 'below': '<', '<': '<',
                        'שווה ל': '=', 'equal to': '=', '=': '='
                    }
            ...
            for match in date_matches:
                ...
                if "פדיון" in query_text or "maturity" in query_text:
                    ...
                    prefix = query_text[max(0, match.start() - 10):match.start()].strip()
            ...
            if sort_match:
                ...
                direction = 'desc' if any(term in sort_match.group(2) for term in ['desc', 'יורד', 'בסדר יורד']) else 'asc'
